# Operator Quickstart — Grain Mill Products Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1061** (`cloud-itonami-isic-1061`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1061.git
cd cloud-itonami-isic-1061
```
...
- Blueprint governor key: `millops-governor`
- Likely source path: `millops.governor.cljc`
