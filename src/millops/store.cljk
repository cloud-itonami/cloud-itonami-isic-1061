(ns millops.store
  "Store abstraction for grain-mill-products production batches. Current
  ...
  A production batch is the minimal unit of work: one milling run of a
  grain-mill product, tracked from grain intake through milling,
  inspection, and shipment. Representative batch keys:
    - :product-type keyword product id (see `millops.facts/product-types`)
    - :jurisdiction keyword jurisdiction id (see `millops.facts/jurisdictions`)
    - :moisture-percent / :ash-content-percent / :granulation-microns /
      :mycotoxin-ppb finished-product actuals
    ...
    - :magnet-last-calibration-date epoch-ms of last metal-detection
      equipment calibration
    - :weight-variance-grams finished-product weight drift from target
    - :grain-sources grain-source ids milled/blended for this batch
