# Contributing to cloud-itonami-isic-1061

Thank you for your interest in contributing to the Grain Mill Operations actor.

## Scope

This repository is a specialization of the cloud-itonami architecture for ISIC
1061 (manufacture of grain mill products). Contributions should:
...
3. Improve **test coverage** for grain-mill-specific scenarios
...
- Add direct milling-line control (roller mill/sifter/purifier operation remains exclusive to plant staff)
...
2. Link to the relevant ADR (ADR-2607152400 or later)
